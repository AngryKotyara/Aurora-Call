function mountHomeFullscreenFlow() {
  ...
  const flow = hero.querySelector('.xperia-flow') || screen?.querySelector(':scope > .xperia-flow');
...
if (root) new MutationObserver(mountHomeFullscreenFlow).observe(root, { childList: true, subtree: true });
